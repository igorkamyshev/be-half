...
class TelegramBot
{
    ...
    private function handleHelpCommand(User $user)
    {
        ...
        $messages[] = "Доступные команды:       
        + помощь;
        + создать группу;
        + вступить #, где # – индивидуальный номер группы;
        + покинуть группу;
        + моя группа – выводит индивидуальный номер и членов группы;
        + статус – выводит состояние счета.";

        $messages[] = "Для создания транзакции отправьте мне сумму покупки и комментерий (необязательно).
        Сумма будет разделена на два, результат будет записан на счет вашего друга, он получит уведомление.
